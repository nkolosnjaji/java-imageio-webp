...
import static io.github.nkolosnjaji.webp.gen.LibWebP.VP8_ENC_ERROR_BAD_DIMENSION;
import static io.github.nkolosnjaji.webp.gen.LibWebP.VP8_ENC_ERROR_BAD_WRITE;
import static io.github.nkolosnjaji.webp.gen.LibWebP.VP8_ENC_ERROR_BITSTREAM_OUT_OF_MEMORY;
import static io.github.nkolosnjaji.webp.gen.LibWebP.VP8_ENC_ERROR_FILE_TOO_BIG;
import static io.github.nkolosnjaji.webp.gen.LibWebP.VP8_ENC_ERROR_INVALID_CONFIGURATION;
import static io.github.nkolosnjaji.webp.gen.LibWebP.VP8_ENC_ERROR_NULL_PARAMETER;
import static io.github.nkolosnjaji.webp.gen.LibWebP.VP8_ENC_ERROR_OUT_OF_MEMORY;
import static io.github.nkolosnjaji.webp.gen.LibWebP.VP8_ENC_ERROR_PARTITION0_OVERFLOW;
import static io.github.nkolosnjaji.webp.gen.LibWebP.VP8_ENC_ERROR_PARTITION_OVERFLOW;
import static io.github.nkolosnjaji.webp.gen.LibWebP.VP8_ENC_ERROR_USER_ABORT;
import static io.github.nkolosnjaji.webp.gen.LibWebP.VP8_ENC_OK;
